...
export default function Portfolio({ data }) {
  return (
    <section className="container mx-auto flex flex-col items-center mt-0">
      <Fade bottom>
        <h1 className="text-5xl text-theme-blue text-center font-bold">See where we are helping</h1>

        <p className="font-light text-lg text-gray-400 text-center mb-12">
          Industries and projects we are involved in
        </p>
      </Fade>
                    ...
                    data.map((item, index) => (
                      <Fade bottom delay={500 * index}>
                        <Button type="link" href={`/project/${item.id}`}>
                          <div className="group rounded-2xl shadow-xl w-auto w-11/12 m-3 transform transition duration-500 hover:scale-110 portofolio-card bg-card-black">
                            ...
                            <div className="py-4">
                              <h2 className="text-k-White text-center text-xl">{item.title}</h2>
